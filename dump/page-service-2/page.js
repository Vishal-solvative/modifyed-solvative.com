                            ...
                            <div className='row'>
                                <div className='col-lg-12 text-center'>
                                    <h1 className='text-display-2'>
                                        Advanced <span className='color-green-900'>analytics</span> to
                                        <br className='d-lg-block d-none' />
                                        grow your business
                                    </h1>
                                    <p className='text-body-lead-large color-gray-500 mt-40 pr-40'>
                                        Connect your conversations with the tools and services that you use to get the
                                        job done. With over 1,500 apps and a robust API
                                    </p>
                                    <div className='mt-40 text-center'>
                                        <Link href='/page-about-1' legacyBehavior>
                                            <a className='btn btn-black icon-arrow-right-white'>Get Started</a>
                                        </Link>
