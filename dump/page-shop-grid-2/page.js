                            ...
                            <div className='filters-products d-flex'>
                                <div className='number-info'>
                                    <strong className='text-body-lead color-gray-500'>
                                        There are <span className='color-green-900'>1853</span> products in this
                                        category
                                    </strong>
                                </div>
                        ...
                        <div className='col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 dr-ltr'>
                            <div className='sidebar'>
                                ...
                                <div className='widget-content'>
                                    <div className='mt-30'>
                                        <span className='color-gray-500 d-inline-block mr-5'>Price Range:</span>
                                        <span className='text-heading-5 color-green-900 d-inline-block'>
                                            <span id='price-from'>$16</span> - <span id='price-to'>$173</span>
                                        </span>
                                        <input
                                    ...
                                    <ul className='list-type'>
                                        <li>
                                            <label className='cb-container text-body-text color-gray-500'>
                                                <input type='checkbox' />
                                                <span className='text-lbl'>Professional</span>
                                        ...
                                        <li>
                                            <label className='cb-container text-body-text color-gray-500'>
                                                <input type='checkbox' />
                                                <span className='text-lbl'>Students</span>
                                                <span className='checkmark'></span>
                                            </label>
                                        </li>
                                        <li>
                                            <label className='cb-container text-body-text color-gray-500'>
                                                <input type='checkbox' />
                                                <span className='text-lbl'>Office</span>
                                                <span className='checkmark'></span>
                                            </label>
                                        </li>
                                        <li>
                                            <label className='cb-container text-body-text color-gray-500'>
                                                <input type='checkbox' />
                                                <span className='text-lbl'>Company</span>
                                                <span className='checkmark'></span>
                                            </label>
                                        </li>
                                        <li>
                                            <label className='cb-container text-body-text color-gray-500'>
                                                <input type='checkbox' />
                                                <span className='text-lbl'>Sport</span>
                                                <span className='checkmark'></span>
                                            </label>
                                        </li>
                                    </ul>
                                    ...
                                    <ul className='list-type'>
                                        <li>
                                            <label className='text-body-text color-gray-500'>
                                                <span className='circle-round color-danger'></span> Apply
                                            </label>
                                        </li>
                                        <li>
                                            <label className='text-body-text color-gray-500'>
                                                <span className='circle-round color-success'></span> Assus
                                            </label>
                                        </li>
                                        <li>
                                            <label className='text-body-text color-gray-500'>
                                                <span className='circle-round color-primary'></span> Samsung
                                            </label>
                                        </li>
                                        <li>
                                            <label className='text-body-text color-gray-500'>
                                        ...
                                        <li>
                                            <label className='text-body-text color-gray-500'>
                                                <span className='circle-round color-warning'></span> Toshiba
                                            </label>
                                        </li>
                                    </ul>
                                    <div className='mt-0'>
                                        <Link href='#' legacyBehavior>
                                            <a className='btn btn-filter'>Filter</a>
                                        </Link>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <li>
                                            <div className='product-item-2 product-item-4'>
                                                <div className='product-image'>
                                                    <Link href='#' legacyBehavior>
                                                        <a>
                                                            <img src='/assets/imgs/page/shop1/sp5.png' alt='agon' />
                                                        </a>
                                                    </Link>
                                                </div>
                                                <div className='product-info'>
                                                    <Link href='#' legacyBehavior>
                                                        <a>
                                                            <h3 className='text-heading-7 color-gray-900'>
                                                                HP 232v Printers
                                                            </h3>
                                                        </a>
                                                    </Link>
                                        ...
                                        <li>
                                            <div className='product-item-2 product-item-4'>
                                                <div className='product-image'>
                                                    <Link href='#' legacyBehavior>
                                                        <a>
                                                            <img src='/assets/imgs/page/homepage5/sp1.png' alt='agon' />
                                                        </a>
                                                    </Link>
                                                </div>
                                                <div className='product-info'>
                                        ...
                                        <li>
                                            <div className='product-item-2 product-item-4'>
                                                <div className='product-image'>
                                                    <Link href='#' legacyBehavior>
                                                        <a>
                                                            <img src='/assets/imgs/page/homepage5/sp2.png' alt='agon' />
                                                        </a>
                                                    </Link>
                                                </div>
                                                <div className='product-info'>
                                        ...
                                        <li>
                                            <div className='product-item-2 product-item-4'>
                                                <div className='product-image'>
                                                    <Link href='#' legacyBehavior>
                                                        <a>
                                                            <img src='/assets/imgs/page/homepage5/sp3.png' alt='agon' />
                                                        </a>
                                                    </Link>
                                                </div>
                                                <div className='product-info'>
                                        ...
                                        <li>
                                            <div className='product-item-2 product-item-4'>
                                                <div className='product-image'>
                                                    <Link href='#' legacyBehavior>
                                                        <a>
                                                            <img src='/assets/imgs/page/shop1/sp4.png' alt='agon' />
                                                        </a>
                                                    </Link>
                                                </div>
                                                <div className='product-info'>
                            ...
                            <div className='sidebar sidebar-gray'>
                                ...
                                <div className='widget-content'>
                                    ...
                                    <form className='form-newletters mt-15' action='#'>
                                        <input className='text-email' placeholder='Enter email address' />
                                        <input
                                            className='btn btn-green-900 btn-green-small mt-20'
                                            type='submit'
                                            value='Submit'
                                        />
                                    </form>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-lg-6 text-end'>
                                <Link href='/page-signup' legacyBehavior>
                                    <a className='btn btn-default hover-up icon-arrow-right mt-10'>Browse All</a>
                                </Link>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/pc.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/headphone.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/laptop.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/mobile.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/printer.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/book.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/tablet.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/usb.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/mouse.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/security.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/watch.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                            ...
                            <div className='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12'>
                                <div className='category-grid-3 hover-up'>
                                    <div className='category-img'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/scan.svg' alt='agon' />
                                            </a>
                                        </Link>
                                    </div>
                                ...
                                <div className='product-item-1 hover-up'>
                                    <Link href='#' legacyBehavior>
                                        <a>
                                            ...
                                            <div className='product-info'>
                                                <h3 className='title-product'>Bass ultra x-203. Head phone</h3>
                                ...
                                <div className='product-item-1 hover-up'>
                                    <Link href='#' legacyBehavior>
                                        <a>
                                            ...
                                            <div className='product-info'>
                                                <h3 className='title-product'>Boxie by Dro C 3450. Active Noise</h3>
                                ...
                                <div className='product-item-1 hover-up'>
                                    <Link href='#' legacyBehavior>
                                        <a>
                                            ...
                                            <div className='product-info'>
                                                <h3 className='title-product'>Sony DSC H300 - 20.1 Megapixel</h3>
                            ...
                            <div className='col-xl-4 col-lg-6 col-md-12 col-sm-12'>
                                <div className='product-item-1 hover-up'>
                                    <Link href='#' legacyBehavior>
                                        <a>
                                            <div className='product-image'>
                                                <img src='/assets/imgs/page/homepage5/sp4.png' alt='agon' />
                                            </div>
                                            <div className='product-info'>
                                                <h3 className='title-product'>Bass ultra x-203. Head phone</h3>
                            ...
                            <div className='col-xl-4 col-lg-6 col-md-12 col-sm-12'>
                                <div className='product-item-1 hover-up'>
                                    <Link href='#' legacyBehavior>
                                        <a>
                                            <div className='product-image'>
                                                <img src='/assets/imgs/page/homepage5/sp5.png' alt='agon' />
                                            </div>
                                            <div className='product-info'>
                                                <h3 className='title-product'>Boxie by Dro C 3450. Active Noise</h3>
                            ...
                            <div className='col-xl-4 col-lg-6 col-md-12 col-sm-12'>
                                <div className='product-item-1 hover-up'>
                                    <Link href='#' legacyBehavior>
                                        <a>
                                            <div className='product-image'>
                                                <img src='/assets/imgs/page/homepage5/sp6.png' alt='agon' />
                                            </div>
                                            <div className='product-info'>
                                                <h3 className='title-product'>Sony DSC H300 - 20.1 Megapixel</h3>
                    ...
                    <div className='container'>
                        <div className='box-green box-green-2 bdr-18'>
                            ...
                            <div className='mt-60'>
                                <Link href='#' legacyBehavior>
                                    <a className='mr-20'>
                                        <img src='/assets/imgs/page/homepage5/apple-button.svg' alt='agon' />
                                    </a>
                                </Link>
                                <Link href='#' legacyBehavior>
                                    <a>
                                        <img src='/assets/imgs/page/homepage5/google-play.svg' alt='agon' />
                                    </a>
                                </Link>
                            </div>
                            <div className='mt-10'>
                            ...
                            <div className='block-1 d-none d-lg-block'>
                                <img src='/assets/imgs/page/shop1/safety.png' alt='agon' />
                            </div>
                            <div className='block-2 d-none d-lg-block'>
                                <img src='/assets/imgs/page/shop1/chart.png' alt='agon' />
                            </div>
                        </div>
                    </div>
                </section>
