        ...
        <>
            <Layout>
                ...
                <div className='container'>
                    <h3 className='text-heading-1 text-center mt-50 mb-50'>
                            ...
                            <div className='col-lg-10'>
                                <div className='block-pricing-3 mb-90'>
                                    <div className='row'>
                                            ...
                                            <div className='block-pricing-left'>
                                                <div className='box-switch'>
                                                    <label>
                                                        ...
                                                        <span
                                                            className={
                                                                isToggled && 'text-billed text-billed-month active'
                                                            }
                                                        >
                                                            Monthly
                                                        </span>
                                                        <span
                                                            className={
                                                                !isToggled && 'text-billed text-billed-year active'
                                                            }
                                                        >
                                                            Yearly
                                                        </span>
                                        ...
                                        <div className='col-xl-6 col-lg-12 col-sm-12'>
                                            <div className='block-price-item active' data-package={3}>
                                                <span className='checkbox' />
                                                <div className='block-pricing-info'>
                                                    <h3 className='text-heading-5 color-gray-900 mb-15'>Standard</h3>
                                                    <span className='tag-round text-body-text'>Save %20</span>
                                                </div>
                                                <div className='box-info-price'>
                                                    ...
                                                    <span className='text-month text-body-text color-gray-500'>
                                                        /{isToggled ? ' Month' : ' Year'}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className='block-price-item' data-package={3}>
                                                <span className='checkbox' />
                                                <div className='block-pricing-info'>
                                                    <h3 className='text-heading-5 color-gray-900 mb-15'>Essentials</h3>
                                                    <span className='tag-round text-body-text'>Save %20</span>
                                                </div>
                                                <div className='box-info-price'>
                                                    <span className='text-heading-3 for-month display-month'>
                                            ...
                                            <div className='block-price-item' data-package={4}>
                                                <span className='checkbox' />
                                                <div className='block-pricing-info'>
                                                    <h3 className='text-heading-5 color-gray-900 mb-15'>Premium</h3>
                                                    <span className='tag-round text-body-text'>Save %20</span>
                                                </div>
                                                <div className='box-info-price'>
                                                    <span className='text-heading-3 for-month display-month'>
                                            ...
                                            <div className='block-price-item' data-package={5}>
                                                <span className='checkbox' />
                                                <div className='block-pricing-info'>
                                                    <h3 className='text-heading-5 color-gray-900 mb-15'>Unlimited</h3>
                                                    <span className='tag-round text-body-text'>Save %20</span>
                                                </div>
                                                <div className='box-info-price'>
                                                    <span className='text-heading-3 for-month display-month'>
                                ...
                                <div className='text-center mt-30 mb-100'>
                                    <Link href='/#' legacyBehavior>
                                        <a className='btn btn-black icon-arrow-right-white mb-20 mr-20'>
                                            Start free trial
                                        </a>
                                    </Link>

                                    <Link href='/#' legacyBehavior>
                                        <a className='btn btn-default icon-arrow-right mb-20'>View plans comparison</a>
                                    </Link>
                                </div>
                                <div className='row'>
                                            ...
                                            <div className='table-mw-700'>
                                                <table className='table table-striped table-pricing'>
                                                    <thead>
                                                        <tr>
                                                            <th className='thw-40' />
                                                            <th className='text-center thw-20'>
                                                                <span className='text-heading-5 color-gray-900 d-block mb-10'>
                                                                    Basic
                                                                </span>
                                                                <p className='text-body-text color-gray-400 mb-20'>
                                                                    On request
                                                                </p>
                                                            </th>
                                                            <th className='text-center thw-20'>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                Members <span className='icon-question-2' />
                                                            </td>
                                                            <td>1</td>
                                                            <td>Up to 3</td>
                                                            <td>Unlimited</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                Workspace roles{' '}
                                                                <span className='text-bd-round text-body-small'>
                                                                    soon
                                                                </span>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                Asset library <span className='icon-question-2' />
                                                            </td>
                                                            <td>
                                                                <span className='tick-green' />
                                                            </td>
                                    ...
                                    <div className='col-lg-6 col-sm-12'>
                                        <div className='bg-2 box-square'>
                                            ...
                                            <p className='text-body-text-md color-gray-600'>
                                                Your site is not complete with only landings. Get essential inner pages
                                                using our ready demos.
                                            </p>
