                                        ...
                                        <div className='mt-50'>
                                            <div className='row'>
                                                <div className='col-lg-3 col-sm-4 col-4'>
                                                    ...
                                                    <p className='text-body-text-md color-gray-500'>Happy Clients</p>
                                                </div>
                                                <div className='col-lg-3 col-sm-4 col-4'>
                                                    <h3 className='text-heading-4 color-gray-900 mb-15'>
                                                        +<span className='count'>45</span>k
                                                    </h3>
                                                    <p className='text-body-text-md color-gray-500'>Project Done</p>
                                                </div>
                                                <div className='col-lg-3 col-sm-4 col-4'>
                                                    <h3 className='text-heading-4 color-gray-900 mb-15'>
                                ...
                                <div className='col-lg-12'>
                                    <ul className='list-partners'>
                                        ...
                                        <li>
                                            <Link href='/#' legacyBehavior>
                                                <a className='item-logo box-hover-shadow hover-up'>
                                                    <img alt='Agon' src='assets/imgs/slider/logo/sample-logo-9.svg' />
                                                </a>
                                            </Link>
                                        </li>{' '}
                                    </ul>
                        ...
                        <div className='container mt-120'>
                            <div className='row'>
                                ...
                                <div className='col-lg-6 col-sm-12 block-we-do-2'>
                                    ...
                                    <h3 className='text-heading-1 mt-30'>Fresh Ideas. Thoughtful Design.</h3>
                                    <p className='text-body-lead-large color-gray-600 mt-30'>
                                        Feugiat primis ligula risus auctor egestas and augue viverra mauri tortor in
                                        iaculis magna a feugiat mauris ipsum and placerat viverra tortor gravida purus.
                                    </p>
                                    <div className='list-icons mt-50'>
                                        <div className='item-icon none-bd'>
                                            <span className='icon-left'>
                                                <img src='/assets/imgs/page/homepage2/icon-work.svg' alt='Agon' />
                                            </span>
                                        ...
                                        <div className='item-icon none-bd'>
                                            <span className='icon-left'>
                                                <img src='/assets/imgs/page/homepage2/icon-design.svg' alt='Agon' />
                                            </span>
                                        ...
                                        <div className='item-icon none-bd'>
                                            <span className='icon-left'>
                                                <img src='/assets/imgs/page/homepage2/icon-advance.svg' alt='Agon' />
                                            </span>
                    ...
                    <section className='section-box mt-lg-100'>
                        <div className='container'>
                            <div className='row'>
                                <div className='col-lg-2 col-sm-1 col-12' />
                                <div className='col-lg-8 col-sm-10 col-12 text-center mt-40'>
                                    <h2 className='text-heading-1 color-gray-900 mb-10'>Built exclusively for you</h2>
                                    <p className='text-body-lead-large color-gray-600 mt-20'>
                                        Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                                        deserunt mollit laborum — semper quis lectus nulla.
                                    </p>
                            ...
                            <div className='row'>
                                <div className='col-lg-6 col-sm-12 mb-30'>
                                    ...
                                    <p className='text-body-lead-large color-gray-600 mt-30'>
                                        ...
                                        benchmarks.Take your career to next level. Apply to our team and see what we can
                                        do together. You’re good enough.
                                    </p>
                                        ...
                                        <div className='col-lg-6 col-md-12 col-sm-12'>
                                            <div className='card-grid-style-2 hover-up mb-20'>
                                                ...
                                                <p className='text-body-text color-gray-600 mt-20 text-comment'>
                                                    ...
                                                    adults into account, it would still not reach an intoxicating level
                                                    in children.
                                                </p>
                                        ...
                                        <div className='col-lg-6 col-md-12 col-sm-12'>
                                            <div className='card-grid-style-2 hover-up mb-20'>
                                                ...
                                                <p className='text-body-text color-gray-600 mt-20 text-comment'>
                                                    ...
                                                    lockdown. Our church began to livestream our services, and Scan had
                                                    a great selection of hardware....”
                                                </p>
                                                <div className='box-img-user'>
                                                    <div className='img-user'>
