                                ...
                                <div className='row'>
                                    <div className='col-lg-6 col-md-12 col-sm-12'>
                                        <div className='card-grid-style-2 hover-up mb-20'>
                                            ...
                                            <p className='text-body-text color-gray-600 mt-20 text-comment'>
                                                Even factoring differences in body weight between children and adults
                                                into account, it would still not reach an intoxicating level in
                                                children.
                                            </p>
                                    ...
                                    <div className='col-lg-6 col-md-12 col-sm-12'>
                                        <div className='card-grid-style-2 hover-up mb-20'>
                                            ...
                                            <p className='text-body-text color-gray-600 mt-20 text-comment'>
                                                So yes, the alcohol (ethanol) in hand sanitizers can be absorbed through
                                                the skin, but no, it would not cause intoxication.
                                            </p>
                                            <div className='box-img-user'>
                                                <div className='img-user'>
                                    ...
                                    <div className='col-lg-6 col-md-12 col-sm-12'>
                                        <div className='card-grid-style-2 hover-up mb-20'>
                                            ...
                                            <p className='text-body-text color-gray-600 mt-20 text-comment'>
                                                “It has been an absolute pleasure dealing with Scan during the lockdown.
                                                Our church began to livestream our services, and Scan had a great
                                    ...
                                    <div className='col-lg-6 col-md-12 col-sm-12'>
                                        <div className='card-grid-style-2 hover-up mb-20'>
                                            ...
                                            <p className='text-body-text color-gray-600 mt-20 text-comment'>
                                                ...
                                                thoroughly blown away! It’s the book I wish I had when I started my dev
                                                career.”
                                            </p>
                                            <div className='box-img-user'>
                                                <div className='img-user'>
