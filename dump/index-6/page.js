                                ...
                                <div className='col-lg-5 d-none d-lg-block'>
                                    <div className='banner-imgs'>
                                        <div className='block-1 shape-1'>
                                            <img src='/assets/imgs/page/homepage6/line-chart.svg' alt='Agon' />
                                        </div>
                                ...
                                <div className='mt-40 box-mw-610'>
                                    <div className='form-newsletter-2'>
                                        <form>
                                            ...
                                            />
                                            <button className='btn btn-newsletter icon-arrow-right-white' type='submit'>
                                                Get A Quote
                                            </button>
                                        </form>
                                    </div>
                        ...
                        <div className='box-bg-bottom'>
                            <div className='box-video-homepage6'>
                                <div className='box-image mt-30 mb-30'>
                                    ...
                                    <img className='img-responsive bdrd-16' src='assets/imgs/page/homepage6/img.png' />
                                </div>
                            </div>
                            <div className='row'>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-xl-7 col-lg-6 col-sm-12 block-we-do'>
                                ...
                                <p className='text-body-lead-large color-gray-600 mt-30'>
                                    ...
                                    publication news while still not being ready.
                                </p>
                            ...
                            <div className='row'>
                                ...
                                <div className='col-lg-8'>
                                    <div className='row'>
                                        ...
                                        <div className='col-lg-6'>
                                            <div className='form-group'>
                                                <input className='form-control' value='' placeholder='Your email' />
                                            </div>
                                        </div>
                                        <div className='col-lg-6'>
                                            <div className='form-group'>
                                                <input className='form-control' value='' placeholder='Phone number' />
                                            </div>
                                        </div>
