                    ...
                    <div className='container'>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-lg-8 col-sm-10 col-12 text-center'>
                                ...
                                <p className='text-body-lead-large color-gray-600 mt-20'>
                                    Developers are trusted to create an engaging experience for their companies, so we
                                    build tools to help them.
                                </p>
                            </div>
                            <div className='col-lg-2 col-sm-1 col-12' />
                        </div>
                        ...
                        <div className='row'>
                            <div className='col-lg-4 col-sm-12'>
                                <div className='card-grid-style-3 pb-40 bg-5 mb-30'>
                                    ...
                                    <div className='mt-30'>
                                        <Link href='/page-service-1' legacyBehavior>
                                            <a className='btn btn-default icon-arrow-right'>Learn more</a>
                                        </Link>
                                    </div>
                                </div>
                            </div>
