                        ...
                        <div className='container'>
                            <div className='breadcrumb'>
                                <ul>
                                    ...
                                    <li>
                                        <Link href='page-shop-grid-1.html' legacyBehavior>
                                            <a>Shop</a>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href='page-shop-grid-2.html' legacyBehavior>
                                            <a>Headphone</a>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href='#' legacyBehavior>
                                            <a>Sony Digital Surround Wireless Headphones</a>
                                        </Link>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div className='product-info'>
                                            <div className='d-flex'>
                                                <div className='box-category-product'>
                                                    <span className='tag-category'>{singleStore.brand}</span>
                                                </div>
                                            ...
                                            <div className='box-price'>
                                                <span className='price'>${singleStore.newPrice}</span>
                                                <span className='price-old'>${singleStore.oldPrice}</span>
                                                <span className='text-stock'>(In stock)</span>
                                            </div>
                                            <p className='text-body-text color-gray-500'>
                                                The WH-L600 delivers cinematic surround sound to immerse you in whatever
                                                you are watching or listening to. Sound modes enhance movies, dialogue,
                                                games, and sport, while a 98.43-ft wireless listening range gives you
                                            ...
                                            <div className='detail-extralink mb-30'>
                                                ...
                                                <div className='product-extra-link2'>
                                                    <button className='button button-add-to-cart' type='submit'>
                                                        <img src='/assets/imgs/page/single-product/cart.svg' /> Add to
                                                        cart
                                                    </button>
                                                    <Link href='#' legacyBehavior>
                                                        <a className='action-btn hover-up' aria-label='Add To Wishlist'>
                                                            <img src='/assets/imgs/page/single-product/heart.svg' />
                                                        </a>
                                                    </Link>
                                                    <Link href='#' legacyBehavior>
                                                        <a className='action-btn hover-up' aria-label='Compare'></a>
                                                    </Link>
                                                </div>
                                            </div>
                                            <div className='box-categories-link'>
                                                <div className='item-cat'>
                                                    <span className='text-body-text color-gray-900'>Vendor:</span>
                                                    <Link href='#' legacyBehavior>
                                                        <a className='text-body-text color-gray-500'>AgonMart</a>
                                                    </Link>
                                                </div>
                                                <div className='item-cat'>
                                                    <span className='text-body-text color-gray-900'>SKU:</span>
                                                    <Link href='#' legacyBehavior>
                                                        <a className='text-body-text color-gray-500'>ABJK767C878</a>
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className='col-lg-12'>
                                                ...
                                                <div className='tab-content mt-50'>
                                                    ...
                                                    >
                                                        ...
                                                        <h3 className='text-body-text font-bold color-gray-500 mt-30'>
                                                            E9SNWHL600B
                                                        </h3>
                                                        <ul>
                                                            <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                Deco Gear 6FT Universal 4K HDMI 2.0 Cable with 28AWG
                                                    ...
                                                    >
                                                        <div className='vendor-logo d-flex mb-30'>
                                                            ...
                                                            <div className='vendor-name ml-15'>
                                                                <h6>
                                                                    <Link href='vendor-details-2.html' legacyBehavior>
                                                                        <a>Noodles Co.</a>
                                                                    </Link>
                                                                </h6>
                                                        ...
                                                        <p className='text-body-text color-gray-500'>
                                                            Noodles and Company is an American fast-casual restaurant
                                                            that offers international and American noodle dishes and
                                                            pasta in addition to soups and salads. Noodles and Company
                                                            ...
                                                            were 460 Noodles and Company locations across 29 states and
                                                            Washington, D.C.
                                                        </p>
                                                    </div>
                                                    <div
                                                                            ...
                                                                            <div className='user justify-content-between d-flex'>
                                                                                ...
                                                                                <div className='desc'>
                                                                                    ...
                                                                                    <p className='mb-10 text-body-text color-gray-500'>
                                                                                        ...
                                                                                        nesciunt facilis itaque modi
                                                                                        commodi dignissimos sequi
                                                                                        repudiandae minus ab deleniti
