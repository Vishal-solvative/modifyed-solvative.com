                        ...
                        <div className='filters-products d-flex'>
                            <div className='number-info'>
                                <strong className='text-body-lead color-gray-500'>
                                    There are <span className='color-green-900'>1853</span> products in this category
                                </strong>
                            </div>
                                            ...
                                            <div className='product-info'>
                                                ...
                                                <div className='rating mt-10'>
                                                    <div className='box-rating'>
                                                        ...
                                                        />
                                                        <span></span>
                                                        <img src='/assets/imgs/page/homepage5/star.svg' alt='agon' />
                                                    </div>
                            ...
                            <div className='col-lg-4 col-sm-6 pr-30 mb-50'>
                                <div className='card-grid-style-4'>
                                    <div className='grid-4-img color-bg-9 mb-20'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/img.png' alt='Agon' />
                                            </a>
                                        </Link>
                                    </div>
                                    <Link href='#' legacyBehavior>
                                    ...
                                    <div className='blog-img-user'>
                                        <div className='img-user img-user-round'>
                                            <img src='/assets/imgs/page/blog/2/user-1.png' alt='Agon' />
                                        </div>
                            ...
                            <div className='col-lg-4 col-sm-6 pr-30 mb-50'>
                                <div className='card-grid-style-4'>
                                    <div className='grid-4-img color-bg-2 mb-20'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/img-2.png' alt='Agon' />
                                            </a>
                                        </Link>
                                    </div>
                                    <Link href='#' legacyBehavior>
                                    ...
                                    <div className='blog-img-user'>
                                        <div className='img-user img-user-round'>
                                            <img src='/assets/imgs/page/blog/2/user-2.png' alt='Agon' />
                                        </div>
                                        <h4 className='text-heading-6 color-gray-900'>Jenny Wilson</h4>
                                        <p className='text-body-small color-gray-500'>August 25, 2022</p>
                                    </div>
                            ...
                            <div className='col-lg-4 col-sm-12 pr-30 mb-50'>
                                <div className='card-list-style-1'>
                                    ...
                                    <div className='style-1-img color-bg-10'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/img-3.png' alt='Agon' />
                                            </a>
                                        </Link>
                                    </div>
                                </div>
                                <div className='card-list-style-1'>
                                    ...
                                    <div className='blog-img-user'>
                                        <div className='img-user img-user-round'>
                                            <img src='/assets/imgs/page/blog/2/user-4.png' alt='Agon' />
                                        </div>
                                    ...
                                    <div className='style-1-img color-bg-2'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/img-4.png' alt='Agon' />
                                            </a>
                                        </Link>
                                    </div>
                                </div>
                                <div className='card-list-style-1'>
                                    ...
                                    <div className='blog-img-user'>
                                        <div className='img-user img-user-round'>
                                            <img src='/assets/imgs/page/blog/2/user-5.png' alt='Agon' />
                                        </div>
                                    ...
                                    <div className='style-1-img color-bg-5'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/img-5.png' alt='Agon' />
                                            </a>
                                        </Link>
                                    </div>
                                </div>
                                <div className='card-list-style-1'>
                                    ...
                                    <div className='blog-img-user'>
                                        <div className='img-user img-user-round'>
                                            <img src='/assets/imgs/page/blog/2/user-6.png' alt='Agon' />
                                        </div>
                                    ...
                                    <div className='style-1-img color-bg-9'>
                                        <Link href='#' legacyBehavior>
                                            <a>
                                                <img src='/assets/imgs/page/shop1/img-6.png' alt='Agon' />
                                            </a>
                                        </Link>
                                    </div>
                                </div>
