                            ...
                            <div className='row'>
                                <div className='col-xxl-7 col-xl-6 col-lg-6 col-md-12 login-left pl-0 d-none d-lg-flex'>
                                    <img
                                        ...
                                        src='/assets/imgs/page/login/img-1.png'
                                        alt='Agon'
                                    />
                                </div>
                                            ...
                                            <div className='box-form-signup'>
                                                ...
                                                <div className='form-group'>
                                                    <Link href='/page-reset' legacyBehavior>
                                                        <a className='text-body-text'>Forgot password?</a>
                                                    </Link>
                                                </div>
                                                <div className='form-group'>
                                                    <button className='btn btn-green-full text-heading-6'>
                                                        Continue
                                                    </button>
                                                </div>
                                                <div>
                                                    ...
                                                    <Link href='/page-signup' legacyBehavior>
                                                        <a className='text-body-text color-green-900'>Sign up</a>
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
