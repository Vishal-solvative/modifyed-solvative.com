                            ...
                            <div className='row'>
                                ...
                                <div className='col-lg-8'>
                                    ...
                                    <p className='text-body-text'>
                                        The AliStudio Design team has a vision to establish a trusted platform that
                                    ...
                                    <p className='text-body-text'>
                                        The ideal candidate will have strong creative skills and a portfolio of work
                                        which demonstrates their passion for illustrative design and typography. This
                                        candidate will have experiences in working with numerous different design
                            ...
                            <div className='row'>
                                ...
                                <div className='col-lg-8'>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            The ability to scope and estimate efforts accurately and prioritize tasks
                                    ...
                                    <h2 className='text-heading-4'>Essential Knowledge, Skills, and Experience</h2>
                                    <p>
                                        Product knowledge: Deeply understand the technology and features of the product
                                    ...
                                    <p>
                                        ...
                                        analyses, user flows, low fidelity wireframes, high fidelity mockups,
                                        prototypes, etc.) that solve real user problems through the user experience.
                                    </p>
                                    <p>
                                        Communication: Communicate the results of UX activities within your product area
                                        to the design team department, cross-functional partners within your product
                                        area, and other interested Superformula team members using clear language that
                                    ...
                                    <div className='media-block'>
                                        ...
                                        <Link href='/page-contact' legacyBehavior>
                                            <a className='btn btn-default icon-arrow-right'>Contact Us</a>
                                        </Link>
