                            ...
                            <div className='box-signup'>
                                ...
                                <Link href='/#' legacyBehavior>
                                    <a className='btn btn-login-google color-gray-500 text-heading-6 box-shadow-2'>
                                        <img
                                            className='img-responsive img-middle mr-10'
                                            src='assets/imgs/template/icons/Icon-gg-login.svg'
                                            alt='Agon'
                                        />{' '}
                                        Sign up with Google
                                    </a>
                                ...
                                <div className='text-center'>
                                    <div className='mt-40 box-line-throught mb-40'>
                                ...
                                <div className='box-form-signup mb-200'>
                                    <div className='form-group'>
                                        ...
                                        <Link href='/#' legacyBehavior>
                                            <a className='link-edit text-body-text'>Edit</a>
                                        </Link>
                                    </div>
                                    <div className='form-group'>
                                    ...
                                    <div className='form-group'>
                                        <div className='form-field'>
                                            <span className='text-body-small color-green-900 tag-top'>Password</span>
                                            <input
                                    ...
                                    <div className='form-group'>
                                        <div className='form-field'>
                                            <span className='text-body-small color-green-900 tag-top'>
                                                Re-type Password
                                            </span>
                                            <input
                                                className='form-control input-green-bd input-with-icon'
                                    ...
                                    <div className='form-group'>
                                        <label className='text-body-small color-gray-500'>
                                            <input className='chkbox' type='checkbox' /> Agree to
                                            <Link href='/#' legacyBehavior>
                                    ...
                                    <div className='form-group'>
                                        <button className='btn btn-green-full text-heading-6'>Continue</button>
                                    </div>
                                    <div>
                                        <span className='text-body-text color-gray-500'>Already have an account?</span>
                                        <Link href='/page-login' legacyBehavior>
                                            <a className='text-body-text color-green-900'>Sign in now</a>
                                        </Link>
                                    </div>
                                </div>
                            </div>
