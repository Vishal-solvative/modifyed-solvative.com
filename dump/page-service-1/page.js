                                ...
                                <div className='col-lg-5 d-none d-lg-block'>
                                    <div className='banner-imgs'>
                                        <div className='block-1 shape-2'>
                                            <img src='/assets/imgs/page/services/1/banner-2.png' alt='Agon' />
                                        </div>
                        ...
                        <div className='row'>
                            <div className='col-lg-3 col-md-6 col-sm-6 col-12'>
                                <div className='list-icons'>
                                    <div className='item-icon none-bd'>
                                        <span className='icon-left'>
                                            <img src='/assets/imgs/page/services/1/icon-support.svg' alt='Agon' />
                                        </span>
                                        <h4 className='text-heading-6'>Support Engineer</h4>
                                        <p className='text-body-text color-gray-600 mt-15'>
                                            We commit to original work of the highest standard and giving credit where
                                            its due.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className='col-lg-3 col-md-6 col-sm-6 col-12'>
                                <div className='list-icons'>
                                    <div className='item-icon none-bd'>
                                        <span className='icon-left'>
                                            <img src='/assets/imgs/page/services/1/icon-web.svg' alt='Agon' />
                                        </span>
                                        <h4 className='text-heading-6'>Web Developer</h4>
                                        <p className='text-body-text color-gray-600 mt-15'>
                                            We become a bonafide agency with a tiny team of 3 and then hire our first
                                            developers
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className='col-lg-3 col-md-6 col-sm-6 col-12'>
                                <div className='list-icons'>
                                    <div className='item-icon none-bd'>
                                        <span className='icon-left'>
                                            <img src='/assets/imgs/page/services/1/icon-business.svg' alt='Agon' />
                                        </span>
                            ...
                            <div className='col-lg-3 col-md-6 col-sm-6 col-12'>
                                <div className='list-icons'>
                                    <div className='item-icon none-bd'>
                                        <span className='icon-left'>
                                            <img src='/assets/imgs/page/services/1/icon-product.svg' alt='Agon' />
                                        </span>
                            ...
                            <div className='col-lg-3 col-md-6 col-sm-6 col-12'>
                                <div className='list-icons'>
                                    <div className='item-icon none-bd'>
                                        <span className='icon-left'>
                                            <img src='/assets/imgs/page/services/1/icon-share.svg' alt='Agon' />
                                        </span>
                            ...
                            <div className='col-lg-3 col-md-6 col-sm-6 col-12'>
                                <div className='list-icons'>
                                    <div className='item-icon none-bd'>
                                        <span className='icon-left'>
                                            <img src='/assets/imgs/page/services/1/icon-build.svg' alt='Agon' />
                                        </span>
                                        <h4 className='text-heading-6'>Support Engineer</h4>
                                        <p className='text-body-text color-gray-500 mt-15'>
                                            We commit to original work of the highest standard and giving credit where
                            ...
                            <div className='col-lg-3 col-md-6 col-sm-6 col-12'>
                                <div className='list-icons'>
                                    <div className='item-icon none-bd'>
                                        <span className='icon-left'>
                                            <img src='/assets/imgs/page/services/1/icon-team.svg' alt='Agon' />
                                        </span>
                                        <h4 className='text-heading-6'>Support Engineer</h4>
                                        <p className='text-body-text color-gray-500 mt-15'>
                                            We commit to original work of the highest standard and giving credit where
                        ...
                        <div className='row'>
                            <div className='col-lg-6 col-sm-12 mb-30'>
                                ...
                                <p className='text-body-lead-large color-gray-600 mt-30'>
                                    ...
                                    benchmarks.Take your career to next level. Apply to our team and see what we can do
                                    together. You’re good enough.
                                </p>
