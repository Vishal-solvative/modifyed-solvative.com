                    ...
                    <div className='container mt-90'>
                        <div className='row'>
                            ...
                            <div className='col-lg-6 col-sm-12 block-we-do-2'>
                                <span className='tag-1 color-orange-900'>What We Do, What You Get</span>
                    ...
                    <div className='container'>
                        <div className='row'>
                            <div className='col-lg-5 mb-30'>
                                <span className='tag-1 bg-9 color-gray-900'>Built Exclusively For You</span>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-lg-6 col-md-12 col-sm-12'>
                                        <div className='card-grid-style-2 card-square hover-up mb-20'>
                                            <p className='text-body-text color-gray-600 text-comment'>
                                                {
                                                    'Wow what great service, I love it! Its is the most valuable business resource we have EVER purchased. We can not understand how we have been living without it. I could not have asked for more than this.'
                                                }
                                            </p>
                                            <div className='box-img-user'>
                                                <div className='img-user img-user-round'>
