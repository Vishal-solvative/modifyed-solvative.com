                        ...
                        <div className='container mt-50'>
                            <div className='row'>
                                <div className='col-lg-7'>
                                    <span className='tag-1 bg-6 color-green-900'>CHECK OUR BEST PROMOTIONS</span>
                                    <h1 className='text-display-4 font-bold mt-30'>
                                        Search Your <span className='color-green-900'>Next Holiday</span> from Our
                                        Destinations
                                    </h1>
                                    <p className='text-body-lead-large color-gray-500 mt-40 pr-40'>
                                        Get a website to be found on the first page of Google to avoid missing out on
                                        potential visitors and sales.
                                    </p>
                                    ...
                                    <div className='banner-imgs d-flex'>
                                        <div className='rounded-img shape-1'>
                                            <img
                                                ...
                                                alt='Agon'
                                                src='assets/imgs/page/homepage8/banner1.png'
                                            />
                                        </div>
                                        <div className='rounded-img mt-20 shape-1-2'>
                                            <img
                                                className='img-responsive'
                                                alt='Agon'
                                                src='assets/imgs/page/homepage8/banner2.png'
                                            />
                                        </div>
                                        <div className='rounded-img shape-1'>
                                            <img
                ...
                <div className='section-box mt-100'>
                    <div className='container'>
                        ...
                        <p className='text-body-lead-large color-gray-600 mt-20'>
                            We find the absolute best prices on hotels and flights
                    ...
                    <div className='container mt-70'>
                                    ...
                                    <div className='product-info'>
                                        ...
                                        <div className='d-flex mt-20'>
                                            <div className='box-prices'>
                                                <span className='location-icon'>Central Park West, USA</span>
                                            </div>
                                            <div className='box-prices'>
                        ...
                        <div className='text-center mt-30'>
                            <Link href='#' legacyBehavior>
                                <a className='btn btn-black icon-arrow-right-white'>Load more destinations</a>
                            </Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='container mt-100'>
                        <div className='row'>
                            ...
                            <div className='col-lg-6 col-sm-12 block-we-do-2'>
                                ...
                                <p className='text-body-lead-large color-gray-600 mt-20'>
                                    We find the absolute best prices on hotels and flights then we pass these savings
                                    directly to you.
                                </p>
                        ...
                        <div className='row'>
                            <div className='col-lg-6 col-sm-12 block-we-do-2'>
                                ...
                                <p className='text-body-lead-large color-gray-600 mt-30'>
                                    Feugiat primis ligula risus auctor egestas and augue viverra mauri tortor in iaculis
                                    magna a feugiat mauris ipsum and placerat viverra tortor gravida purus.
                                </p>
