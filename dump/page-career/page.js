                            ...
                            <div className='text-center'>
                                ...
                                <div className='mt-50'>
                                    <Link href='/page-about-3' legacyBehavior>
                                        <a className='btn btn-black icon-arrow-right-white mb-15 mr-20'>
                                            Join our team
                                        </a>
                                    </Link>

                                    <Link href='/page-faqs-1' legacyBehavior>
                                        <a className='btn btn-default icon-arrow-right color-gray-900 btn-mb mb-15'>
                                            Learn more
                                        </a>
                                    </Link>
                                </div>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-lg-8 col-sm-10 col-12 text-center mt-100'>
                                <h2 className='text-heading-1 color-gray-900'>
                                    Join a Workplace That
                                    <br className='d-lg-block d-none' />
                                    Gives You More
                                </h2>
                                <p className='text-body-lead-large color-gray-600 mt-20'>
                                    Interactively transform magnetic growth strategies whereas prospective outside the
                                    box thinking.
                                </p>
                            </div>
                            <div className='col-lg-2 col-sm-1 col-12' />
                            ...
                            <div className='col-lg-4 col-sm-12'>
                                <div className='card-grid-1 bg-5 hover-up'>
                                    ...
                                    <p className='text-body-excerpt mt-20'>
                                        You are always welcome to visit our little den. Professional in teir craft! All
                                        products were super amazing with strong attension to details, comps and overall
                                        vibe.
                                    </p>
                                    <div className='mt-30'>
                        ...
                        <div className='row'>
                            <div className='col-lg-5 mb-30'>
                                ...
                                <p className='text-body-lead-large color-gray-600 mt-30'>
                                    There are countless great reasons to work at our company and we hate to brag, but
                                    it’s too hard not to!
                                </p>
                                <div className='mt-40'>
                                    <Link href='/page-service-1' legacyBehavior>
                                        <a className='btn btn-default btn-white icon-arrow-right text-body-text'>
                                            Learn More
                                        </a>
                                    </Link>
                                </div>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-lg-6 col-md-12 col-sm-12'>
                                        <div className='card-grid-style-2 card-square hover-up mb-20'>
                                            <p className='text-body-text color-gray-600 text-comment'>
                                                {
                                                    'Wow what great service, I love it! Its is the most valuable business resource we have EVER purchased. We cant understand how weve been living without it. I couldnt have asked for more than this.'
                                                }
                                            </p>
                                            <div className='box-img-user'>
                                                <div className='img-user img-user-round'>
                                    ...
                                    <div className='col-lg-6 col-md-12 col-sm-12'>
                                        <div className='card-grid-style-2 card-square hover-up mb-20'>
                                            <p className='text-body-text color-gray-600 text-comment'>
                                                {
                                                    'Its is both attractive and highly adaptable. Its exactly what Ive been looking for. Definitely worth the investment.'
                                                }
                                            </p>
                                            <div className='box-img-user'>
                                                <div className='img-user img-user-round'>
