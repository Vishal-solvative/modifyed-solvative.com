            ...
            <div class='row'>
                <div class='col-lg-20'>
                    <div class='box-image mt-30 mb-30'>
                        <a class='popup-youtube btn-play-video btn-play-middle' onClick={openModal}></a>
                        <img
                            ...
                            <div class='media-block'>
                                ...
                                <div class='float-start float-lg-end mt-30'>
                                    <a class='btn btn-media mr-10' href='/#'>
                                        <img src='/assets/imgs/template/icons/facebook-share.svg' alt='Agon' /> Share
                                    </a>
                                    <a class='btn btn-media mr-10' href='/#'>
                                        <img src='/assets/imgs/template/icons/twitter-share.svg' alt='Agon' /> Tweet
                                    </a>
                                    <a class='btn btn-media' href='/#'>
                                        <img src='/assets/imgs/template/icons/pinterest-share.svg' alt='Agon' /> Pin
                                    </a>
                                </div>
                            </div>
                        </div>
