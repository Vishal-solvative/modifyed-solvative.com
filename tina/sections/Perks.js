                        ...
                        <div key={index} className='col-lg-4 col-sm-12'>
                            <div className={`card-grid-1 bg-${index + 1}  hover-up`}>
                                <div className='grid-1-img'>
                                    <img src={perk?.image} alt='Agon' data-tina-field={tinaField(perk, 'image')} />
                                </div>
                                <h3 className='text-heading-3 mt-20' data-tina-field={tinaField(perk, 'title')}>
                                    {perk?.title}
                                </h3>
                                <p className='text-body-excerpt mt-20' data-tina-field={tinaField(perk, 'description')}>
                                    {perk?.description}
                                </p>
                                <div className='mt-30'>
                                    <Link
