...
const ThreeImageComponent = ({props}) => {
    return (
        <div class='row mt-45 mb-30'>
            ...
            <div class='col-lg-6'>
                <img class='img-responsive mb-20' src={props?.image1_1182x627} alt='Agon' />
                <img class='img-responsive' src={props?.image2_1182x627} alt='Agon' />
            </div>
            <div class='caption-img mt-10 text-center color-gray-400'>{props?.desc}</div>
        </div>
    )
}
...
const SideImageComponent = ({props}) => {
    return (
        <div class='row'>
            ...
            <div class='col-lg-4'>
                <img class='img-responsive bdr-10 mt-10' src={props?.image} alt='Agon' />
            </div>
        </div>
    )
}
        ...
        <section class='section-box mt-50 mb-50'>
            <div class='container'>
                <div class='row'>
                    ...
                    <div class='col-lg-1 col-md-2 col-sm-2 col-3 text-center'>
                        <div class='social-sticky'>
                            ...
                            <br />
                            <a class='share-social share-pi' href='/https:/www.pinterest.com'></a>
                        </div>
                    </div>
                    <div class='col-lg-8 col-md-8 col-sm-10 col-9'>
                        <div class='text-summary' data-tina-field={tinaField(fields?.blog, 'blogDescription')}>
                ...
                <div class='row'>
                    ...
                    <div className='col-lg-8' data-tina-field={tinaField(fields?.blog, 'blogContent')}>
                        <TinaMarkdown
                            ...
                            components={{
                                ...
                                img: props => <img className='img-responsive bdr-16' src={props?.url} {...props} />,
