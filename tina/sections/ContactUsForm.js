                ...
                <div className='bdrd-58 box-gray-100 icon-wave'>
                    <div className='row'>
                        ...
                        <div className='col-lg-4 mb-40'>
                            ...
                            <p className='text-body-text color-gray-600' data-tina-field={tinaField(fields, 'address')}>
                                {fields?.address}
                            </p>
                            <p className='text-body-text color-gray-600' data-tina-field={tinaField(fields, 'mobile')}>
                                {fields?.mobile}
                            </p>
                            <p className='text-body-text color-gray-600' data-tina-field={tinaField(fields, 'email')}>
                                {fields?.email}
                            </p>
                        </div>
