            ...
            <div className='container mt-30'>
                <div className='row'>
                    <div className='col-lg-8'>
                        <h3 className='text-heading-1 mb-10' data-tina-field={tinaField(fields, 'primaryHeading')}>
                    ...
                    {fields?.blogList?.map((blog, index) => (
                        <div key={index} class='col-lg-4 col-sm-12 pr-30'>
                            <div class='card-grid-style-4'>
                                <span class='tag-dot' data-tina-field={tinaField(blog?.blog, 'blogTag')}>
                                    {blog?.blog?.blogTag}
                                </span>
                                <Link href={`blog/${blog?.blog?._sys?.filename || '#'}`} legacyBehavior>
                                    <a
                                    ...
                                    <Link href={`blog/${blog?.blog?._sys?.filename || '#'}`} legacyBehavior>
                                        <a>
                                            <img
                                                ...
                                                alt='Agon'
                                                data-tina-field={tinaField(blog?.blog, 'blogImage_1290x1506')}
                                            />
                                        </a>
                                    </Link>
                                </div>
