                        ...
                        {fields?.cards?.map((card, i) => (
                            <div className='col-lg-4 col-sm-12 pr-30 mb-50' key={i}>
                                <div className='card-grid-style-4'>
                                    <span className='tag-dot' data-tina-field={tinaField(card?.blog, 'blogTag')}>
                                        {card?.blog?.blogTag}
                                    </span>
                                    <Link href={`blog/${card?.blog?._sys?.filename} || '#'`} legacyBehavior>
                                        <a
                                        ...
                                        >
                                            <a>
                                                <img
                                                    ...
                                                    alt='Agon'
                                                    data-tina-field={tinaField(card?.blog, 'blogImage_1290x1506')}
                                                />
                                            </a>
                                        </Link>
                                    </div>
