    ...
    return (
        <section className='section-box mt-70'>
            <div className='container mt-50'>
                <h3 className='text-heading-1 text-center mb-10' data-tina-field={tinaField(fields, 'heading1')}>
                    {fields?.heading1}
                </h3>
            </div>
            <div className='container mt-20'>
                <div className='text-center block-bill-2 mt-10'>
                    <span className='text-lg text-billed' data-tina-field={tinaField(fields, 'cb1')}>
                        {fields?.cb1}
                    </span>
                    <label className='switch ml-20 mr-20'>
                        <input id='cb_billed_type' type='checkbox' name='billed_type' onChange={handleCheckboxChange} />
                        <span className='slider round'></span>
                    </label>
                    <span className='text-lg text-billed' data-tina-field={tinaField(fields, 'cb2')}>
                        {fields?.cb2}
                    </span>
                </div>
