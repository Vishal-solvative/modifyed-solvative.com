                        ...
                        <div key={index} className='col-lg-4 col-md-12 col-sm-12'>
                            <div className='list-icons hover-up'>
                                <div className='item-icon'>
                                    ...
                                    <h4 className='text-heading-4' data-tina-field={tinaField(location, 'title')}>
                                        {location?.title}
                                    </h4>
                                    <p className='text-body-text color-gray-1100 mt-15'>
                                        <p data-tina-field={tinaField(location, 'address')}>{location?.address}</p>

                                        <p data-tina-field={tinaField(location, 'mobile')}>Phone: {location?.mobile}</p>

                                        <p data-tina-field={tinaField(location, 'email')}>Email:{location?.email}</p>
                                    </p>
                                </div>
                            </div>
                        </div>
