            ...
            <div className='container mt-120'>
                <div className='row'>
                    ...
                    <div className='col-lg-6 col-sm-12 block-we-do'>
                        <span className='tag-1 bg-6 color-green-900' data-tina-field={tinaField(fields, 'tag')}>
                            {fields?.tag}
                        </span>
                        <h3 className='text-heading-1 mt-30' data-tina-field={tinaField(fields, 'primaryHeading')}>
